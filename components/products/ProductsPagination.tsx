        ...
        <nav className="flex justify-center py-10">
            {page > 1 && (
                <Link
                    ...
                    className="bg-white px-4 py-2 text-sm text-gray-900 ring-1 ring-inset ring-gray-300 focus:z-20 focus:outline-offset-0 flex items-center justify-center"
                > <ArrowLeftIcon className='w-4 h-4' /> </Link>
            )}
